...
```bash
$ cd ~/work
$ touch my3-7-01_replicate.py
# VS Codeでファイルを開いて、上記のコードをコピー&ペースト
$ python my3-7-01_replicate.py
```
...
```bash
$ cd ~/work
$ touch my3-7-01_replicate.R
# VS Codeでファイルを開いて、上記のコードをコピー&ペースト
$ Rscript my3-7-01_replicate.R
```
...
2. my3-7-01_replicate.py/Rを実行して動作を確認
3. 自分で似たような関数を書いてみる
...
```bash
$ cd ~/work
$ touch my3-7-02_map_vector.py
# VS Codeで上記コードを入力
$ python my3-7-02_map_vector.py
```
...
```bash
$ cd ~/work
$ touch my3-7-02_map_vector.R
# VS Codeで上記コードを入力
$ Rscript my3-7-02_map_vector.R
```
...
**ファイル名**: `my3-7-03_map_dataframe.py`
...
```bash
$ cd ~/work
$ touch my3-7-03_map_dataframe.py
# VS Codeで上記コードを入力
$ python my3-7-03_map_dataframe.py
```
...
**ファイル名**: `my3-7-03_map_dataframe.R`
...
```bash
$ cd ~/work
$ touch my3-7-03_map_dataframe.R
# VS Codeで上記コードを入力
$ Rscript my3-7-03_map_dataframe.R
```
...
2. my3-7-03_map_dataframe.py/Rを実行
...
```bash
$ cd ~/work
$ touch my3-7-04_pmap.py
# VS Codeで上記コードを入力
$ python my3-7-04_pmap.py
```
...
```bash
$ cd ~/work
$ touch my3-7-04_pmap.R
# VS Codeで上記コードを入力
$ Rscript my3-7-04_pmap.R
```
...
```bash
$ cd ~/work
$ touch my3-7-05_parallel.R
# VS Codeで上記コードを入力
$ Rscript my3-7-05_parallel.R
```
...
```bash
$ cd ~/work
$ touch my3-7-05_parallel.py
# VS Codeで上記コードを入力
$ python my3-7-05_parallel.py
```
...
**Python版**: `ex3-7-01_monte_carlo.py`  
**R版**: `ex3-7-01_monte_carlo.R`
...
```bash
$ cd ~/work
$ touch ex3-7-01_monte_carlo.py
# VS Codeで上記コードを入力
$ python ex3-7-01_monte_carlo.py
```

#### 解答例（R）

**ファイル名**: `ex3-7-01_monte_carlo.R`
...
```bash
$ cd ~/work
$ touch ex3-7-01_monte_carlo.R
# VS Codeで上記コードを入力
$ Rscript ex3-7-01_monte_carlo.R
```
...
**ファイル名**: `ex3-7-02_data_pipeline.py`
...
```bash
$ cd ~/work
$ touch ex3-7-02_data_pipeline.py
# VS Codeで上記コードを入力
$ python ex3-7-02_data_pipeline.py
```

#### 解答例（R）

**ファイル名**: `ex3-7-02_data_pipeline.R`
...
- [ ] 乱数を使った繰り返し計算を実装できる
- [ ] my3-7-01_replicate.py/Rを実行して動作を確認した
- [ ] 繰り返し回数を変更して実験できる
...
- [ ] 複数のサンプルサイズで計算を実行できる
- [ ] my3-7-02_map_vector.py/Rを実行して動作を確認した
- [ ] 関数を変更して異なる計算を試せる
...
- [ ] my3-7-03_map_dataframe.py/Rを実行して動作を確認した
...
- [ ] パラメータグリッドの概念を理解している
- [ ] 複数引数を持つ関数を各行に適用できる
- [ ] my3-7-04_pmap.py/Rを実行して動作を確認した
...
- [ ] my3-7-05_parallel.py/Rを実行して動作を確認した
...
- [ ] ex3-7-01_monte_carlo.py/Rのいずれかを完成させた
- [ ] モンテカルロ法の原理を理解している
- [ ] サンプルサイズと推定精度の関係を確認した
- [ ] ex3-7-02_data_pipeline.py/Rのいずれかを完成させた
- [ ] 複数の統計分布の特性を比較できた
- [ ] 歪度と尖度の意味を理解している
- [ ] パラメータグリッドを作成できる
- [ ] 複数のパターンを組み合わせて使える
