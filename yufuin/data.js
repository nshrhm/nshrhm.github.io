...
const SHOPPING = [
  ...
  {group:'肉・魚介', item:'鮭切り身', amount:'4切れ', owner:'現地補充', priority:'高齢者向け'},
  ...
  {group:'野菜・副菜', item:'ミニトマト', amount:'2パック', owner:'八代1号車候補', priority:'口直し'},
  {group:'野菜・副菜', item:'サラダ野菜', amount:'1〜2袋', owner:'現地補充', priority:'口直し'},
  {group:'野菜・副菜', item:'枝豆', amount:'2袋', owner:'現地補充', priority:'酒飲み向け'},
  ...
  {group:'主食・朝食', item:'パン', amount:'8〜12個分', owner:'北九州車候補', priority:'朝食'},
  {group:'主食・朝食', item:'卵', amount:'10個', owner:'現地補充', priority:'朝食'},
  {group:'主食・朝食', item:'ヨーグルト', amount:'8個', owner:'現地補充', priority:'朝食'},
  {group:'主食・朝食', item:'果物', amount:'8人分', owner:'八代1号車候補', priority:'朝食・デザート'},
  ...
  {group:'飲み物', item:'ビール・発泡酒', amount:'350ml×16〜18本', owner:'北九州車＋現地', priority:'酒飲み4人'},
  {group:'飲み物', item:'ハイボール・チューハイ', amount:'350ml×8本', owner:'現地補充', priority:'酒飲み4人'},
  {group:'飲み物', item:'焼酎', amount:'720ml×1本', owner:'八代1号車候補', priority:'お土産感'},
